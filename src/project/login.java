...
public class login{
	...
	void logsetdata(String a,String d,String e) {
	...
	login(){
		...
		ImageIcon i = new ImageIcon("C:/Users/91938/OneDrive/Documents/java/PROJECT/img/lo.png");
		JLabel img = new JLabel("",i,JLabel.CENTER);
		img.setBounds(720, 150, 200, 200);
		f.add(img);
		
		ImageIcon i1 = new ImageIcon("C:/Users/91938/OneDrive/Documents/java/PROJECT/img/u.png");
		JLabel img1 = new JLabel("",i1,JLabel.CENTER);
		img1.setBounds(290, 190, 200, 50);
		f.add(img1);
		
		ImageIcon i2 = new ImageIcon("C:/Users/91938/OneDrive/Documents/java/PROJECT/img/p.png");
		JLabel img2 = new JLabel("",i2,JLabel.CENTER);
		img2.setBounds(290, 250, 200, 50);
		f.add(img2);
		
		ImageIcon i3 = new ImageIcon("C:/Users/91938/OneDrive/Documents/java/PROJECT/img/r.png");
